...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        # TODO: finish this function!
        #raise NotImplementedError
        return_score = float('-inf') if maximizing_player else float('inf')
        return_move = (-1, -1)
        ...
        return return_score, return_move
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def get_move(self, game, time_left):
        ...
        **********************************************************************
        ...
        search_plan = eval('self.' + self.method)

        try:
            if self.iterative:
                for depth in range(1, game.width * game.height):
                    score, move = search_plan(game, depth)
                    if score == float('inf'):
                        break
            else:
                score, move = search_plan(game, self.search_depth)
            pass
